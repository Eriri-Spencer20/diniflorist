...
<body>
    ...
    <div class="agileits_header">
        <div class="container">
            <div class="w3l_offers">
                <p>
                    <marquee> DAPATKAN PENAWARAN MENARIK HARI INI, BELANJA SEKARANG! </marquee>
                </p>
            </div>
            <div class="agile-login">
				...
				if(!isset($_SESSION['log'])){
					...
					echo '
					<li style="color:#333333">Halo, '.$_SESSION["name"].'
    ...
    <ul id="demo1">
        ...
        <li>
            <img src="produk/unnamed.jpg" alt="" />
        </li>
                ...
                <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
                    <div id="myTabContent" class="tab-content">
                        <div role="tabpanel" class="tab-pane fade in active" id="expeditions"
                            ...
                            <div class="agile-tp">
                                <h5>Produk Pilihan Kami
                                    <?php
								if(!isset($_SESSION['name'])){
									
								} else {
									echo 'Hanya Untukmu, '.$_SESSION['name'].'!';
								}
								?>
                                </h5>
                            </div>
                            <div class="agile_top_brands_grids">
                                ...
                                <?php 
											$brgs=mysqli_query($conn,"SELECT * from produk order by idproduk DESC limit 6 ");
											$no=1;
