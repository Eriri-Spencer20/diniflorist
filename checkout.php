...
<head>
    <title> Dini Florist - Checkout</title>
    <!-- for-mobile-apps -->
...
<body>
    ...
    <div class="checkout">
        <div class="container">
            <h1> Terima kasih, <?=$_SESSION['name']?> telah membeli <?php echo $itungtrans3 ?> produk di
                Dini Florist</span></h1>
                ...
                <div class="col-md-4 w3_footer_grid">
                    ...
                    <ul class="address">
                        ...
                        <li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a
                                href="mailto:info@email">dinimartini4d@iemail</a></li>
