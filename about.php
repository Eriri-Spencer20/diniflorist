...
<head>
    <title>Dini Florist - Tentang Kami</title>
    <!-- for-mobile-apps -->
    ...
    <div class="agileits_header">
        <div class="container">
            <div class="w3l_offers">
                <p>
                    <marquee>DAPATKAN PENAWARAN MENARIK HARI INI, BELANJA SEKARANG!</marquee></a>
                </p>
            </div>
    ...
    <div class="logo_products">
        <div class="container">
            ...
            <div class="w3ls_logo_products_left">
                <h1><a href="index.php">Dini Florist</a></h1>
            </div>
        ...
        <div class="container">
            ...
            <div class="about-agileinfo w3layouts">
                <div class="col-md-12 about-wthree-grids grid-top ">
                    <h4>
                        DIni Florist adalah usaha penyediaan bunga berbentuk karangan, bucket, kalung bunga,
                        juga hiasan bunga untuk meja yang ada dengan service paling baik buat anda. Pekerjaan kami buat
                        sekitaran anda terlihat lebih berseri, prima serta megah.
        ...
        <div class="container">
            <div class="w3_footer_grids">
                <div class="col-md-4 w3_footer_grid">
                    ...
                    <ul class="address">
                        <li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Bogor,Jawa Barat
                        </li>
                        <li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a
                                href="mailto:info@email">dini_martini4@email</a></li>
                        <li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>+6289611548553</li>
                    </ul>
                </div>
        ...
        <div class="container">
            <div class="w3layouts-foot">
                <ul>
                    ...
                    <li><a href="https://wa.me/+6289611548553" class="agile_whatsapp"><i class="fa fa-whatsapp"
